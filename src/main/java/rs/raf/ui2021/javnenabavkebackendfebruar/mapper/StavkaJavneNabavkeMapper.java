...
public class StavkaJavneNabavkeMapper {
    ...
    public StavkaJavneNabavkeDto stavkaJNToStavkaJNDto(StavkaJavneNabavke stavkaJN){
        ...
        stavkaJNDto.setNSTJIzvsenja(stavkaJN.getNSTJIzvsenja());
    ...
    public StavkaJavneNabavke stavkaJNCreateDtoToStavkaJN(StavkaJavneNabavkeCreateDto stavkaJavneNabavkeCreateDto) throws NotFoundException {
